...
GhostView Ralphthon은 AI 에이전트(Claude Code)가 **자율적으로** 한국 웹사이트 1000개의 접근성을 감사하고, 결과를 리더보드 웹사이트로 빌드/배포하는 프로젝트입니다.
...
| 1 — Scan | 1000개 사이트 배치 스캔 | 80%+ 완료, FP=0, Supabase 동기화 |
